(function ($) {
  ...
  if ($(".blog_single2_left_sidebarlist .nav-sidebar > li").hasClass("active")) {
    $(".blog_single2_left_sidebarlist .nav-sidebar > li.active").find("ul").slideDown(700);
  }

  function active_dropdown3() {
    $(".blog_single2_left_sidebarlist .nav-sidebar > li > a").on("click", function (e) {
      event.preventDefault();
      $(this).parent().find("ul").first().toggle(300);
      $(this).parent().siblings().find("ul").hide(300);
    });
    ...
    if (windowWidth > 576) {
      ...
      $('a[href="#hackers"]').click(function() {
        ...
        $(window).on("scroll", function () {
          ...
          var scrolls = $(window).scrollTop();
          console.log(hackersOffset, scrolls);
